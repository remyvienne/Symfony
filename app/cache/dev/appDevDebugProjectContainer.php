...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'sdz_blog.antispam' => 'getSdzBlog_AntispamService',
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'symfony', 'user' => 'rvienne', 'password' => 'asmfc', 'charset' => 'UTF8', 'driverOptions' => array()), $b, $d, array());
    }
    ...
    /**
     * Gets the 'sdz_blog.antispam' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
    ...
    {
        return $this->services['sdz_blog.antispam'] = new \Sdz\BlogBundle\Antispam\SdzAntispam($this->get('swiftmailer.mailer.default'), 'en', 3);
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'database_user' => 'rvienne',
            'database_password' => 'asmfc',
